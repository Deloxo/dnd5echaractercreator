...
function chooseClass() {
  if (extended == false) {
    ...
    document.getElementById("option1").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Barbarian";
    document.getElementById("option2").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Bard";
    document.getElementById("option3").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Blood Hunter";
    document.getElementById("option4").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Cleric";
    document.getElementById("option5").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Druid";
    document.getElementById("option6").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Fighter";
    document.getElementById("option7").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Monk";
    document.getElementById("option8").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Paladin";
    document.getElementById("option9").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Ranger";
    document.getElementById("option10").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Rogue";
    document.getElementById("option11").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Sorcerer";
    document.getElementById("option12").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Warlock";
    document.getElementById("option13").style.visibility = "visible";
    document.getElementById("option0").innerHTML = "Wizard";
  } else if (extended == true) {
    extended = false;
    optionmode = "";
    document.getElementById("option0").style.visibility = "hidden";
